  ...
  return (
    <div className='page'>
      <div className='page-topbar'>
        <span className='bell-icon' onClick={() => Navigate("/Logout")}>
          {" "}
          logout
        </span>
      ...
      <p className='page-subtitle'>
        Hello, ....! 👋 Track your food, stay healthy and make better choices.
      </p>
      ...
      <div className='hero-card'>
        <div>
          ...
          <p className='hero-text'>
            ...
            recommendations and build better eating habits. Small steps make big
            changes!
          </p>
        </div>
        <button
          onClick={() => Navigate("/Layout/AddFood")}
          className='hero-btn'
        >
          + Go to Add Food →
        </button>
